...
process.SliceTestAnalysis = cms.EDAnalyzer('STASliceTestAnalysis',
    ...
    # vfatStatus = cms.InputTag("muonGEMDigis", "vfatStatus", "reRECO"), 
    # gebStatus = cms.InputTag("muonGEMDigis", "GEBStatus", "reRECO"), 
)
